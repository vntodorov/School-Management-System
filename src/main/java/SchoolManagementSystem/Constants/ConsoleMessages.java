...
public enum ConsoleMessages {
    ...
    public static final String ADD_COUNTRY_BEGIN = "It's time to add a new country in the school. Please fill up the requested information below:";
    public static final String ADD_TOWN_BEGIN = "It's time to add a new town in the school. Please fill up the requested information below:";
    ...
    public static final String TOWN_NAME = "Town's name: ";
